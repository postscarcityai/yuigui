...
say "Slide g to 1.62 to swing it on the Moon."`,
  ...
  {
    // Feedback APSw0dsa: a lesson of many pieces is one full screen, not loose cards in the chat.
    slug: "lesson-one-screen",
    name: "Lesson: compound interest on one full screen",
    agent: "Yui",
    yl: `say "Compound interest in a minute. It's all on one screen."
>full
shapes "Money that grows on itself" caption="Your interest joins the pile, then it earns interest too."
...
deck "Compound interest" +inline
page "The idea" body="You earn interest on your money. Next year you also earn interest on that interest. The pile grows faster every year."
page "Simple vs compound" body="Simple interest only pays on the $100 you started with. Compound interest pays on everything in the pile."
