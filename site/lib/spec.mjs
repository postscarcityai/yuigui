...
const ORDER = [
  ...
  ["talk-about", "Talk about this (draft)", null, "Bring one of your agent's settings into the chat, talk it over, and apply the agent's before and after with one tap, through the same Controls path."],
