...
const pages = ["/", "/mockups", "/roadmap", "/board", "/progress", "/changelog", "/timeline", "/developers", "/playground", "/developers/library", "/yl", "/channel", "/reactions", "/developers/specs", "/developers/community", "/contribute", "/earn", "/thoughts", "/business", "/start", "/help", "/privacy"];
