    ...
    <html lang="en" data-theme="light" className={nunito.variable} suppressHydrationWarning>
      ...
      <body>
        ...
        <footer className="wrap foot">
          ...
          <span>Built in public at yuigui.com</span> | <a href="/business">Business</a> | <a href="https://github.com/postscarcityai/yuigui">GitHub</a> | <a href="/help">Help</a> | <a href="/privacy">Privacy</a>
        </footer>
      </body>
    </html>
  );
