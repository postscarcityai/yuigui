...
const TABLES = [
  ...
  ["yui_oauth_clients", "AI apps that registered to connect (like Claude): name and return address. Nothing about you."],
  ["yui_oauth_requests", "Connect requests: which app, approved or not, by whom. Deleted after a day."],
  ["yui_oauth_tokens", "Keys for the apps you allowed, hashed, tied to the connection you can remove."],
