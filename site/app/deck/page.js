...
const slides = [
  ...
  { h: "How it works", li: ["The agent emits a JSON UI spec", "Yui renders it with a native component kit", "A relay carries it from any agent to any phone, with push and deep links"] },
