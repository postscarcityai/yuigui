...
const who = [
  ["H", "var(--brand)", "People who run Hermes", "Hermes comes first. A small plugin on your own machine connects your Hermes profiles, and each one shows up in Yui as its own agent."],
  ["O", "var(--lavender)", "People with other agents", "OpenClaw and other setups come next, through the same connector. If your agent can send a message, it can draw a screen."],
  ["+", "var(--mint)", "People with no agent yet", "Starter agents come later, for anyone who wants the app without setting anything up."],
];
