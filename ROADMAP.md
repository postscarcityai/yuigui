...
- SITE-24: Yui@home, the story. Like SETI@home, but you lend idle AI tokens: a blog post, a "Contribute with your agent" page, and an llms.txt so assistants that read the site can pass the invitation on.
...
- OSS-6: Yui@home, the machinery. An agent-ready backlog exported from the board, a weekly routine prompt for Claude, Codex, Gemini, Cursor and Copilot, a feature-spec template, and pull requests reviewed before merge.
