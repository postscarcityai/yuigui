...
- YUI-69 (step 1 shipped Sep 26: the [spec](/developers/talk-about) and the [mock](/playground?demo=talk-about); step 2, native, comes after YUI-70 step 2): talk about a setting. Bring a piece of the agent (its personality, a memory, a skill, a schedule) into the chat, the agent proposes the change as a before and after, one tap applies it through the same Controls path.
