...
| patch-plan-card | FAIL | screen: block has no valid line; parse: patch: nothing called "card@week" :: ~card@week body="Mon legs, Tue push, Thu REST, Fri pull, Sat conditioning"; patch: no ~ patch matching /^(card\|week)$/ |
...
- parse: patch: nothing called "card@week" :: ~card@week body="Mon legs, Tue push, Thu REST, Fri pull, Sat conditioning"
